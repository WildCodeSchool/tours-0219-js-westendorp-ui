...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'presentation', component: PresentationComponent, data: { routeIdx: 1 } },
      { path: 'techniques', component: TechnicReglementationComponent, data: { routeIdx: 2 } },
      { path: 'produits', component: ProductsComponent, data: { routeIdx: 3 } },
      { path: 'actualites', component: ActualityComponent, data: { routeIdx: 4 } },
      { path: 'activites', component: ActivityComponent, data: { routeIdx: 5 } },
